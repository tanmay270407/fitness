...
<%
    ...
    Integer dailyGoalAttr = (Integer) session.getAttribute("dailyGoal");
    int dailyGoalVal = dailyGoalAttr != null ? dailyGoalAttr : 2000;
%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
        ...
        <div class="container">
                    ...
                    <div class="card-header">
                        ...
                        <div>
                            <div class="card-label">Daily Goal</div>
                                        <div class="card-value" id="dailyGoal"><%= dailyGoalVal %></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="dashboard-card card card-glass">
                    <div class="card-header">
                        ...
                        <div>
                            ...
                            <div class="card-value" id="remainingCalories"><%= dailyGoalVal %></div>
                        </div>
                    </div>
                </div>
            ...
            <div class="progress-section card card-glass">
                ...
                <div class="progress-footer">
                    <span>0 cal</span>
                    <span id="goalText">Goal: <%= dailyGoalVal %> cal</span>
                </div>
            </div>
    ...
    <style>
        ...
        @media (max-width: 480px) {
            ...
            <script>
                // expose server-calculated daily goal to JS
                const SERVER_DAILY_GOAL = <%= dailyGoalVal %>;
        // Mobile menu toggle
        ...
        function updateMetrics() {
            ...
            document.getElementById('remainingCalories').textContent = Math.max(0, SERVER_DAILY_GOAL - total);
        }

        function updateProgressBar() {
            updateMetrics();
            const total = parseInt(document.getElementById('totalCalories').textContent);
            const percentage = Math.min(100, (total / SERVER_DAILY_GOAL) * 100);
