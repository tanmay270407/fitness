                ...
                <div class="form-section card card-glass">
                    ...
                    <form id="workoutForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="workoutDuration" placeholder="e.g., 30" required>
                        </div>

                        <div class="form-group">
                            <label for="workoutCalories">Calories Burned</label>
                            <input type="number" id="workoutCalories" placeholder="e.g., 250" required>
                        </div>

                        <div class="form-group">
                            <label for="workoutNotes">Notes (optional)</label>
                            <textarea id="workoutNotes" placeholder="Add any notes..."></textarea>
                        </div>
